...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/L3UHUl8Ra8)
...
```sh
npx nx serve vue-template-project
```

To create a production bundle:

```sh
npx nx build vue-template-project
```

To see all available targets to run for a project, run:

```sh
npx nx show project vue-template-project
```
